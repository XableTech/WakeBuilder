...
def list_all_models():
    ...
    recommended = [
        ...
        (
            ...
            "Multi-lingual, voice cloning capable",
        ),
        (
            "tts_models/multilingual/multi-dataset/xtts_v2",
            "Latest XTTS, 17 languages, voice cloning",
        ),
...
def interactive_demo():
    ...
    while True:
        try:
            cmd = input(
                f"\n[Speaker {current_speaker_idx}: {tts.speakers[current_speaker_idx]}] > "
            ).strip()
...
Examples:
  ...
  python explore_coqui_tts.py --interactive
    ...
    parser.add_argument(
        "--list-models", action="store_true", help="List all available TTS models"
    )
    parser.add_argument(
        "--list-voices",
        type=str,
    ...
    parser.add_argument(
        "--language", type=str, help="Language code for multilingual models"
    )
    parser.add_argument(
        "--explore-vits", action="store_true", help="Explore all VITS models in detail"
    )
    parser.add_argument(
        "--interactive",
        action="store_true",
