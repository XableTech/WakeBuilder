...
def convert_directory(
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for mp3_path in mp3_files:
            ...
            future = executor.submit(convert_mp3_to_wav, mp3_path, wav_path, target_sr)
...
def main():
    ...
    parser.add_argument(
        "input_dir", type=Path, help="Input directory containing MP3 files"
    )
    parser.add_argument(
        "-o",
        "--output-dir",
    ...
    parser.add_argument(
        "--stats-only", action="store_true", help="Only show statistics, don't convert"
    )
